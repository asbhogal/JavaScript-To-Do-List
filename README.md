...
A To Do List application which allows users to add and remove tasks, as well as keep track of tasks entered via Local Storage. This has been built using HTML5, CSS (SCSS), JavaScript and Vite.
